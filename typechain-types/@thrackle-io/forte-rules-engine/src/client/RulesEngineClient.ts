...
export interface RulesEngineClientInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "rulesEngineAddress"
...
export interface RulesEngineClient extends BaseContract {
  connect(runner?: ContractRunner | null): RulesEngineClient;
  waitForDeployment(): Promise<this>;

  interface: RulesEngineClientInterface;
