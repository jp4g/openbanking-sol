...
import type * as mockOfacSanctionSol from "./MockOfacSanction.sol";
export type { mockOfacSanctionSol };
import type * as rulesEngineIntegrationSol from "./RulesEngineIntegration.sol";
export type { rulesEngineIntegrationSol };
